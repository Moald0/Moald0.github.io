...
const quizData = [
    {
        question: "Hva er vesktfart?",
        a: "Økning per tid - reduksjon per tid",
        b: "Reduksjon per tid - økning for tid",
        c: "Økning per tid + reduksjon per tid",
        d: "Reduksjon per tid + økning for tid",
        correct: "a",
    },
];
